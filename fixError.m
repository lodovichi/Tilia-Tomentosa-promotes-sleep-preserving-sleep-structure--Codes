...
% Parabolic fit for removal of 50 and 100 Hz artifact
...
for mouse=1:5
    for Ch=1:2
        for State=1:3
            ...
            totalCntN50 (mouse,Ch,State, ind100Hz2+1:ind100Hz3-1) = fit100;
        end
    end
end
